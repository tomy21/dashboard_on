...
export default function CardTop({ title, value }) {
  return (
    <div>
      <div className="border border-slate-400 bg-white shadow-md rounded-md w-full h-24 md:w-52 md:h-32 text-start px-3 py-2">
        <h1 className="text-xs md:text-sm font-medium mb-2 text-gray-400">
          {title}
        </h1>
        <hr />
